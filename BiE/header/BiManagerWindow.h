#ifndef _H_BiManagerWindow_H_
#define _H_BiManagerWindow_H_
...
class BiManagerWindow : public QMainWindow
{
	Q_OBJECT

public:
    BiManagerWindow(QWidget *parent = 0);
